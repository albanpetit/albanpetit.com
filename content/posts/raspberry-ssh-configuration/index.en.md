...
lang: en
date: 2024-01-05
description: "How to enable and configure SSH on a Raspberry Pi — from basic setup to SSH keys and port changes."
tags:
  - Bash
  - Raspberry Pi
  - Raspbian
...
Similar to the [Wi-Fi configuration](/post/raspberry-wifi-config/), you can configure some important elements of the **SSH** server even before the first boot of the Raspberry using the **Raspberry Pi Imager** utility.
...
```bash
ssh pi@address_ip -p connection_port
```
